...
$db = new PDO('mysql:host='.$db_host.';dbname='.$database,
	...
	if (empty($news_id))	{
		...
		*/
		...
		/*if deletebtnClicked {
			$db -> query("DELETE FROM ch_news WHERE news_id = $news_id")
		}*/
		...
		<table border="0" cellpadding="0" cellspacing="0" width="80%" align="center">
			...
			<tr>
				...
				<td>
					...
					<input type="button" name="delete" value="<?php echo $news_id?>" onclick=<?php $db -> query("DELETE FROM ch_news WHERE news_id = $news_id") ?>/>
